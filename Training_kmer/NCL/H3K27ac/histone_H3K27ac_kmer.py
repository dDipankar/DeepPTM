...
if __name__ == '__main__':
 ...
 posfile = 'H3K27ac'+"_"+"kmer_pos_ncl.csv"
 if os.path.exists(posfile):
	 os.remove(posfile)
 fpos = open(posfile,'a')
 negfile = 'H3K27ac'+"_"+"kmer_neg_ncl.csv"
 ...
 #val
 val_neg_H3K27ac = neg_sam_H3K27ac[14712:16814:]
 val_pos_H3K27ac = pos_sam_H3K27ac [2887:3176,:]
 ...
 #test
 test_neg_H3K27ac = neg_sam_H3K27ac[16814:,:]
