...
if __name__ == '__main__':
 ...
 output_H3K27me3 = out_label.values[:,2]
 y = np.array(output_H3K27me3, dtype='int8')
 ...
 if os.path.exists(h5filename):
	...
	in_group.create_dataset('H3K27me3_RPKM',data = X_resampled, dtype = np.float64, compression ='gzip')
	out_group = h5file.create_group('output')
	out_group.create_dataset('H3K27me3',data = y_resampled, dtype = np.int8, compression ='gzip')	 
