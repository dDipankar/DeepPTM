...
if __name__ == '__main__':
 ...
 X_train_H3K27me3 = np.array(X_train_H3K27me3, dtype= 'float64')
 X_val_H3K27me3 = np.array(X_val_H3K27me3, dtype= 'float64')
 X_test_H3K27me3 = np.array(X_test_H3K27me3, dtype= 'float64')
 h5file.create_dataset('/input/H3K27me3_train_ncl',data= X_train_H3K27me3, dtype =np.float64, compression ='gzip')
 h5file.create_dataset('/input/H3K27me3_val_ncl',data= X_val_H3K27me3, dtype =np.float64, compression ='gzip')
 h5file.create_dataset('/input/H3K27me3_test_ncl',data= X_test_H3K27me3, dtype =np.float64, compression ='gzip')
 h5file.create_dataset('/output/H3K27me3_train_ncl',data=Y_train_H3K27me3, dtype = np.int8, compression ='gzip')
 h5file.create_dataset('/output/H3K27me3_val_ncl',data=Y_val_H3K27me3, dtype = np.int8, compression ='gzip')
 h5file.create_dataset('/output/H3K27me3_test_ncl',data=Y_test_H3K27me3, dtype = np.int8, compression ='gzip')
 h5file.close() 
 '''
 #building model
 model = Sequential()
 model.add(Dense(units=256, input_dim=30, activation="relu", kernel_initializer='glorot_uniform')) # kernel_regularizer=l2(0.0001), 115
